...
# JDBC
jdbc.db.url=jdbc:postgresql://#JDBC_DB_URL#/#MEDIA_JDBC_DB_NAME#?user=#MEDIA_JDBC_DB_USER#&password=#MEDIA_JDBC_DB_PASS#
...
# File System
media.storage.root=/var/lib/media-storage
